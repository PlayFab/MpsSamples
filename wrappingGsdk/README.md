...
If you did the Local Server Agent [example] (https://learn.microsoft.com/en-us/gaming/playfab/features/multiplayer/servers/localmultiplayeragent/local-multiplayer-agent-overview), check on the PortMappingsList's Game Port Name of the settings file you used, use the same for the PortName field, either using [Container] https://github.com/(PlayFab/MpsAgent/blob/main/LocalMultiplayerAgent/MultiplayerSettingsLinuxContainersOnWindowsSample.json) or [Process] (https://github.com/PlayFab/MpsAgent/blob/main/LocalMultiplayerAgent/MultiplayerSettings.json)
